...
| `is_dm` | `bool` | No | Flag to specify whether the room is a direct-message room (according to account data). If absent the room is not a DM room. Must be included in an incremental sync if the DM state changes. |
