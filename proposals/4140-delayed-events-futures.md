...
The server will respond with HTTP 404 and an `M_NOT_FOUND` error
...
Delayed events could be sent over federation immediately and then have the receiving servers process
