...
##### Send a payload to the rendezvous session: `PUT /_matrix/client/v1/{rendezvousId}`
...
##### Receive a payload from the rendezvous session: `GET /_matrix/client/v1/{rendezvousId}`
...
##### Cancel a rendezvous session: `DELETE /_matrix/client/v1/{rendezvousId}`
