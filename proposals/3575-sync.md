...
large accounts. The `room_types` filters exist primarily to include/exclude spaces. 
...
the following rules:
 ...
 - `include_old_rooms`: Presence of this field in any section turns this on.
...
[Proxy server](https://github.com/matrix-org/sliding-sync) (v0.5.1):
 - Sliding Window API:
    - [x] Operation support
