...
```json5
{
  ...
  "lists": {
    ...
    "client_chosen_key": {
      ...
      // Sticky. Allowlist of event types which should cause the list of rooms to be reordered.
      // Empty lists or omitted lists fall back to the list ["m.room.message", "m.room.encrypted"].
