...
# Potential issues
- Scope.
- Flexibility with sorting/filtering and client demands.

# Alternatives
- Do nothing, keep using sync v2 and try to make it go fast.
- Factor out some busy bits of sync v2 e.g receipts but still keep returning all rooms (no paginated sync)
