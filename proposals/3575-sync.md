...
{"lists": null}                  // No change, use the `lists` value from the previous request.
...
{"rooms": null}                  // No change, use the `rooms` value from the previous request.
{} // field omitted              // The same: use the previous sticky value.
```

<details>
<summary>Examples of using <code>lists</code> and <code>rooms</code></summary>
